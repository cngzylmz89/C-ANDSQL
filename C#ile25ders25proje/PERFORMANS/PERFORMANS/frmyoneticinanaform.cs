...
namespace PERFORMANS
{
    public partial class frmyoneticinanaform : Form
    {
        ...
        void ogretmenkayitlistele()
        {
            ...
            con.Open();
            OleDbDataAdapter ogretmenlistele=new OleDbDataAdapter("select OGRETMENID AS 'ÖĞRETMEN ID', TCKIMLIKNO AS 'TC KİMLİK NUMARASI', ADISOYADI AS 'ADI SOYADI',SIFRE AS 'ŞİFRESİ', BRANSADI AS 'BRANŞI' from TBLOGRETMENLER INNER JOIN TBLBRANSLAR ON TBLBRANSLAR.BRANSID=TBLOGRETMENLER.BRANS ORDER BY OGRETMENID ASC",con);
            DataTable dt=new DataTable();
            ogretmenlistele.Fill(dt);
        ...
        private void btnyenihaftaac_Click(object sender, EventArgs e)
        {
            ...
            if (haftaacoku == "musait")
            {
                ...
                {
                    con.Open();
                    OleDbCommand haftaacguncelle = new OleDbCommand("update TBLDERSPROGRAMI SET HAFTA="+hafta, con);
